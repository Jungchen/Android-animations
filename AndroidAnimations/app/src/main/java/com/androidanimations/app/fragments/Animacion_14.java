...
public class Animacion_14 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        set.playTogether(
                ObjectAnimator.ofFloat(imagen, "rotation", 900),
                ObjectAnimator.ofFloat(imagen, "translationY", 450, -450),
                ObjectAnimator.ofFloat(imagen, "translationX", -400, 400)
        );
